...
export default function Gameplay() {
  ...
  const storyData = {
    ...
    The authorities at the farm are overwhelmed, the clues are piling up, the suspects are restless, and time is running out.`,
      choices: [{ text: "Go to Sheepy Hollow", next: "farm" }],
    },
    farm: {
    ...
    You decide to examine the crime scene...`,
      ...
      choices: [
        ...
        {
          text: "You catch a glimpse of the gold feather",
          next: "goldfeather",
        },
        {
          text: "You follow the direction of Clucklyn's outstretched wing",
          next: "sack",
        },
      ],
    },
...
`,
      choices: [
        ...
        {
          text: "'Officer, leave the gun, take the cannoli.' (the Godfather)",
          next: "vito",
        },
      ],
    },
    ...
    Come to think of it, you've heard of a character of questionable morals with a penchant for shiny things.`,
      choices: [
        {
          text: "This is the day you will always remember as the day you *almost* caught Quack Sparrow.",
          next: "quacksparrow",
        },
        {
          text: "'Officer, leave the gun, take the cannoli.' (the Godfather)",
    ...
    You have more questions than answers but at least now you know who to ask.`,
      choices: [
        {
          text: "It's hard to imagine how heartfelt words could precede a grisly murder but crimes of passion are not rare.",
          next: "hamsolo",
        },
        {
          text: "The paper bears the seal of Quack Sparrow's secret smuggling ring. So the goose chase continues.",
          next: "quacksparrow",
        },
      ],
    },
    ...
    You are not sure if you believe him but it is a lead worth following. Who would gain from Ham's downfall? Perhaps someone who also had a horn in the moving of feed on the farm.`,
          next: "vito",
        },

        {
          text: "You can tell Ham is hiding something so you decide to keep an eye on him.",
          next: "hamGuilty",
        },
      ],
    },
      ...
      choices: [
        {
          ...
          Luckily, I have certain methods of persuasion. He admitted to me that in Clucklyn's final days she was searching for something... some sort of egg. \n
            ...
            If it's the stuff of legends, I know who you need to talk to next...`,
          next: "indianabones",
        },
        {
          text: `Goose sounds heartfelt but his reclusive lifestyle and eery calm gives you a bad feeling. \n
            
            He still isn't looking at you so you take the chance to investigate the room. You ruffle a pile of hay in the corner and he turns abruptly.`,
          next: "gooseGuilty",
        },
      ],
    },
    ...
    "I didn't mean to..." he says. "I just.. I just wanted her to love me again".`,
      choices: [
        {
          text: "And, thus, Ham was less like the romantic Romeo and more like the murderous Hamlet.",
          next: "end",
        },
      ],
    },
    ...
    `,
      choices: [
        {
          text: "But you also know that Ham will know who is responsible for the death of his love and, after all, revenge is a dish best served cold.",
          next: "end",
        },
      ],
    },
    gooseGuilty: {
      ...
      choices: [
        {
          text: "You thought solving Clucklyn's murder would be satisfying-- it is anything but. Then again, the night is darkest just before dawn (Batman). You see day break as Officer Quackeres slaps the cuffs on Goose.",
          next: "end",
        },
      ],
    },
    quackGuilty: {
      text: `When he arrives, you hand both vials to Officer Quackers. They haven't been to the lab yet but you know what they will discover. And Quack knows it, too. \n
      ...
      choices: [
        {
          text: `You haven't unraveled his smuggling ring but you have put away a killer. And that has to be enough for today.`,
          next: "end",
        },
      ],
    },
    indianabonesGuilty: {
      ...
      choices: [
        {
          text: `"Horses. Why did it have to be horses (Indiana Jones)", he mutters as Officer Quackers slaps the cuffs on him.`,
          next: "end",
        },
      ],
    },
    end: {
      text: `Would you do it differently next time?`,
  ...
  return (
    <div className="my-10 w-1/2 flex flex-col items-center mx-auto">
      ...
      <p className="pb-10">
        {/* <p className="bg-white rounded-md p-10">{storyData[currentNode].text}</p> */}
        {storyData[currentNode].text.split("\n").map((line, index) => (
      ...
      <div className="flex flex-row flex-wrap justify-center">
        {storyData[currentNode].choices.map((choice, index) => (
          <button
            key={index}
            onClick={() => handleChoice(choice.next)}
            className="p-3 border-1 border-red-700 text-red-700 rounded-md m-2"
          >
            {choice.text}
          </button>
        ))}
